    ...
    return (
        <section className="mb-20 px-4">
            <div className="flex flex-col items-center mb-12 text-center">
                <h2 className="font-display text-3xl font-bold tracking-tight mb-4 text-white">Technology Stack</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {techStack.map((tech, i) => (
                    ...
                    >
                        ...
                        <div>
                            <h3 className="font-display font-bold text-lg mb-2 text-white">{tech.category}</h3>
