    ...
    return (
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20 px-4">
            <motion.div
                ...
                className="space-y-6"
            >
                <h2 className="font-display text-3xl font-bold tracking-tight text-white">Our Mission</h2>
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                    Our mission is to empower businesses to harness data and intelligent systems.
                </p>
            </motion.div>
            ...
            >
                <div className="absolute -inset-1 bg-gradient-to-r from-accent to-accent/50 rounded-[2rem] blur opacity-15 group-hover:opacity-30 transition duration-1000" />
                    ...
                    <ul className="space-y-4">
                        {visionPoints.map((point, i) => (
                            <motion.li
                                ...
                                className="flex items-center gap-3 text-foreground/80 font-medium text-lg text-white/90"
                            >
